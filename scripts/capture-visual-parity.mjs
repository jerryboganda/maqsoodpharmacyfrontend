...
const outputRoot = process.env.VISUAL_PARITY_DIR || path.join(process.env.TEMP || 'C:\\tmp', 'maqsood-pharma-visual-parity-20260803')
const targets = [
  ['landing', '/'],
  ['dashboard', '/dashboard'],
  ['feature-rule-engine', '/features/rule-engine'],
]
